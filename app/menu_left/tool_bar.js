...
app.directive('selector', function($rootScope, $modal, DrawFactory) {
	return {
		restrict: 'E',
		...
		link: function(scope, iElement, iAttrs) {
			...
			scope.dialog = function() {
				var modal = $modal.open({
					...
					templateUrl: 'menu_left/template/attribute.tpl.html',
					controller: function($scope, $modalInstance, selector) {
...
app.directive('slider', function($rootScope, $modal, DrawFactory) {
	return {
		restrict: 'AC',
		scope: {
			size: '='
...
app.directive('picker', function($rootScope, $modal, DrawFactory) {
	return {
		restrict: 'E',
